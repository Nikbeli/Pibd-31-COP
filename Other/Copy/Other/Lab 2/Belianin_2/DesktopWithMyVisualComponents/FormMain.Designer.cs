namespace DesktopWithMyVisualComponents
{
	partial class FormMain
	{
		...
		private void InitializeComponent()
		{
			...
			this.customInputRangeNumber = new BelianinComponents.CustomInputRangeNumber();
			...
			this.customSelectedCheckedListBoxProperty = new BelianinComponents.CustomSelectedCheckedListBoxProperty();
			...
			this.customTreeView = new BelianinComponents.CustomTreeView();
			...
			this.wordWithImages = new BelianinComponents.WordWithImages(this.components);
			this.wordWithTable = new BelianinComponents.WordWithTable(this.components);
			this.wordWithDiagram = new BelianinComponents.WordWithDiagram(this.components);
